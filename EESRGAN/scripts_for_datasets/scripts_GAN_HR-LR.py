...
try:
    #.path.append('/home/razkey23/cowc-gan/EESRGAN/utils.py')
    #print(sys.path)
    sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    #sys.path.insert(1, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    #import utils 
    print(sys.path)
    from utils.util import imresize_np, calculate_psnr, calculate_ssim
...
def generate_mod_LR_bic():
    ...
    #sourcedir = 'DetectionPatches_256x256/Potsdam_ISPRS'
    sourcedir = '/home/razkey23/cowc-gan/DetectionPatches_256x256/Potsdam_ISPRS'
    #savedir = 'DetectionPatches_256x256/Potsdam_ISPRS'
    savedir = '/home/razkey23/cowc-gan/DetectionPatches_256x256/Potsdam_ISPRS'
